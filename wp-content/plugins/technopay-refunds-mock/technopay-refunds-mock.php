	...
	private function get_reasons() {
		return $this->get_response(
			...
			array(
				...
				'results' => array(
					array( 'code' => '30001', 'reason' => 'کالای آسیب‌دیده یا معیوب',          'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30002', 'reason' => 'ارسال کالای اشتباه',                 'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30003', 'reason' => 'انصراف مشتری',                       'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30004', 'reason' => 'پرداخت تکراری',                      'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30005', 'reason' => 'سایر دلایل',                         'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'other_issues' ),
