	...
	private function get_reasons() {
		return $this->get_response(
			...
			array(
				...
				'results' => array(
					array( 'code' => '30001', 'reason' => 'ناموجودی', 'text' => 'پذیرنده امکان تأمین یا تحویل این کالا را ندارد.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30002', 'reason' => 'مغایرت یا مشکل کالا', 'text' => 'کالای تحویل‌شده دارای ایراد، آسیب‌دیدگی یا مغایرت با سفارش ثبت‌شده است.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30003', 'reason' => 'تاخیر یا عدم ارسال', 'text' => 'سفارش در زمان مقرر ارسال نشده یا به دست مشتری نرسیده است.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30004', 'reason' => 'انصراف از خرید', 'text' => 'مشتری از ادامه خرید منصرف شده و درخواست لغو یا بازگشت وجه/اعتبار دارد.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30005', 'reason' => 'انتخاب اشتباه', 'text' => 'کالا، مدل، تعداد یا مشخصات سفارش به اشتباه توسط مشتری انتخاب شده است.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30006', 'reason' => 'عدم دریافت یا عدم حضور', 'text' => 'مشتری در زمان تحویل حضور نداشته یا از دریافت سفارش خودداری کرده است.', 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30007', 'reason' => 'سایر دلایل', 'text' => null, 'type' => 'REFUND_REQUEST', 'group' => 'refund_request' ),
					array( 'code' => '30011', 'reason' => 'درخواست تکراری', 'text' => null, 'type' => 'REFUND_REJECTION', 'group' => 'refund_request' ),
					array( 'code' => '30012', 'reason' => 'مستندات ناقص', 'text' => null, 'type' => 'REFUND_REJECTION', 'group' => 'refund_request' ),
					array( 'code' => '30013', 'reason' => 'درخواست متقلبانه', 'text' => null, 'type' => 'REFUND_REJECTION', 'group' => 'refund_request' ),
					array( 'code' => '30014', 'reason' => 'مغایرت با قوانین بازگشت وجه', 'text' => null, 'type' => 'REFUND_REJECTION', 'group' => 'refund_request' ),
					array( 'code' => '30015', 'reason' => 'سایر دلایل', 'text' => null, 'type' => 'REFUND_REJECTION', 'group' => 'refund_request' ),
				),
			)
		);
	}
